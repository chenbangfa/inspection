...
//$w="tId='".$_SESSION["tId"]."'";
if($s!="")
	$w .= " AND (hyName = '$s' OR hyTel = '$s') ";
list($cur,$co,$pg,$pe,$ne,$cu,$results) = $db->getList("hyUser",$w,"addtime desc",20);
	$g = $pg;
	$g = $g==0?0:$g;
	$url = "s=$s";
?>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  <div class="row" style=" margin:5px -15px;">
	...
	<input class="form-control" id="search" placeholder="姓名、电话查询" style="width:320px;float:left;">
  ...
  function searchs()
  {
	   window.location.href="hylist.php?s="+$("#search").val()+"&bmname="+$("#bmname").val()+"&state="+$("#state").val();
  }
  </script> 
  <div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel-body">
		  ...
		  ?>
            <tr>
              ...
              <td><?php echo $row["hyTel"];?></td>
              <td><?php echo $db->getTname($row["tId"]);?></td>
              <td><?php echo $db->getIdentity($row["hyIdentity"]);?></td>
              <td><?php echo $row["logTime"];?></td>
              <td><?php echo $row["logNum"];?></td>
              <td><?php echo $row["addTime"];?></td>
              <td><a href="hyedit.php?id=<?php echo $row["id"];?>"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp; <a href="javascript:void();" class="trash del" t="hyUser" i="<?php echo $row["id"];?>" m="hylist.php"><span class="glyphicon glyphicon-trash"></span></a></td>
            </tr>
