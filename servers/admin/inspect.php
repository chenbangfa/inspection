...
if($groupId!="")
	$w .= " AND yhSpeciality='$groupId'";
if($s!="")
	$w .= " AND (hyName = '$s' OR hyTel = '$s' OR gsName = '$s' OR yhAdd = '$s' OR yhPosition = '$s' OR yhContent = '$s') ";
	
list($cur,$co,$pg,$pe,$ne,$cu,$results) = $db->getList("inspect",$w,"addTime desc",20);
	$g = $pg;
	$g = $g==0?0:$g;
	$url = "startime=$startime&endtime=$endtime&groupId=$groupId&s=$s";
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  <div class="row" style=" margin:5px -15px;">
	...
	<input class="form-control" id="search" placeholder="输入巡检人/公司名称/隐患查询" style="width:220px;float:left;">
  ...
  function searchs()
  {
	   window.location.href="inspect.php?startime="+$("#startime").val()+"&endtime="+$("#endtime").val()+"&groupId="+$("#groupId").val()+"&s="+$("#search").val();
  }
  function dc()
  {
	   window.location.href="../sendexcel/inspect.php?startime="+$("#startime").val()+"&endtime="+$("#endtime").val()+"&groupId="+$("#groupId").val()+"&s="+$("#search").val();
  }
  </script> 
  <div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel-body">
		  ...
		  ?>
            <tr>
              ...
              <td><?php echo $row["gsName"];?></td>
              <td><?php echo $row["yhAdd"];?></td>
              <td><?php echo $row["yhPosition"];?></td>
              <td><?php echo $row["yhContent"];?></td>
              <td><?php echo $row["yhSpeciality"];?></td>
              <td><?php echo $row["addTime"];?></td>
              <td>              
              <a href="inspectedit.php?id=<?php echo $row["id"];?>"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp; 
              <a href="javascript:void();" class="trash del" t="inspect" i="<?php echo $row["id"];?>" m="inspect.php"><span class="glyphicon glyphicon-trash"></span></a>
              </td>
            </tr>
