...
if($s!="")
	$w .= " AND (gName like '%$s%') ";
list($cur,$co,$pg,$pe,$ne,$cu,$results) = $db->getList("yhzyGroup",$w,"gSort asc",20);
	$g = $pg;
	$g = $g==0?0:$g;
	$url = "s=$s";
?>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  <div class="row" style=" margin:5px -15px;">
	...
	<input class="form-control" id="search" placeholder="分组名称查询" style="width:220px;float:left;">
  ...
  function searchs()
  {
	   window.location.href="inspectgroup.php?s="+$("#search").val();
  }
  </script> 
  <div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel-body">
		  ...
		  ?>
            <tr>
              ...
              <td><a href="inspectgroupedit.php?id=<?php echo $row["id"];?>"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp; <a href="javascript:void();" class="trash del" t="yhzyGroup" i="<?php echo $row["id"];?>" m="inspectgroup.php"><span class="glyphicon glyphicon-trash"></span></a></td>
            </tr>
