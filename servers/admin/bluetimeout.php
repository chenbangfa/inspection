...
$w="tId='".$_SESSION["tId"]."'";
if($startime!="")
	$w .= " AND startTime>='$startime'";
if($endtime!="")
	$w .= " AND endTime<='$endtime'";
if($s!="")
	$w .= " AND (hyName = '$s' OR dropName = '$s' OR odInfo = '$s') ";
	
list($cur,$co,$pg,$pe,$ne,$cu,$results) = $db->getList("noCheck",$w,"addTime desc",20);
	$g = $pg;
	$g = $g==0?0:$g;
	$url = "startime=$startime&endtime=$endtime&s=$s";
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  <div class="row" style=" margin:5px -15px;">
	...
	<input class="form-control" id="search" placeholder="输入巡检人/巡检点名称查询" style="width:220px;float:left;">
  ...
  function searchs()
  {
	   window.location.href="noCheck.php?startime="+$("#startime").val()+"&endtime="+$("#endtime").val()+"&s="+$("#search").val();
  }
  function dc()
  {
	   window.location.href="../sendexcel/noCheck.php?startime="+$("#startime").val()+"&endtime="+$("#endtime").val()+"&s="+$("#search").val();
  }
  </script> 
  <div class="row">
    <div class="col-lg-12">
