...
Page({
  ...
  stateshow:function(e)
  {
    this.setData({
      stateshow:true
    })
  },
  statehide:function(e)
  {
    this.setData({
      stateshow:false
    })
  ...
  wx.request({
    ...
    success(res) {
      wx.getFileSystemManager().writeFile({
        filePath: wx.env.USER_DATA_PATH + "/周期巡检记录表.xlsx",
        data: res.data,
        encoding:"binary",
        success: res => {
          wx.hideLoading();
