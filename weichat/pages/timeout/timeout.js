  ...
  dataserach:function(e)
  {
   ...
   switch(typedata)
   {
    ...
    case '上周':
      ...
      break;
    case '上月':
      var time = this.data.period.getMonthStartDate1();
      var times = this.data.period.getMonthEndDate1();   
      this.setData({
        sdate:time+" 00:00:00",
        edate:times+" 23:59:59",
        editshow:false,
     ...
     this.loadmydongtai(this,0);    
      break;      
    case '上季':
      var time = this.data.period.getQuarterStartDate1();
      var times = this.data.period.getQuarterEndDate1();  
      this.setData({
        sdate:time+" 00:00:00",
        edate:times+" 23:59:59",
        editshow:false,
     ...
     this.loadmydongtai(this,0);    
      break;
   case '去年':
        var time = this.data.period.getYearStartDate1();
        var times = this.data.period.getYearEndDate1(); 
        this.setData({
          sdate:time+" 00:00:00",
          edate:times+" 23:59:59",
          editshow:false,
...
download()
{
  ...
  wx.request({
    url: "https://xj.tajian.cc/servers/sendexcel/timeout.php",
    data: {
      tid:tid,
      hyid:hyid,
      time:time,
    ...
    success(res) {
      wx.getFileSystemManager().writeFile({
        filePath: wx.env.USER_DATA_PATH + "/超时未检记录表.xlsx",
        data: res.data,
        encoding:"binary",
        success: res => {
          wx.hideLoading();
